...
def run():
    ...
    b['0'].grid(row=4, column=3, ipadx=0, ipady=0, padx=4, pady=4)
    b['1'].grid(row=2, column=1, ipadx=0, ipady=0, padx=4, pady=4)
    b['2'].grid(row=2, column=2, ipadx=0, ipady=0, padx=4, pady=4)
    b['3'].grid(row=2, column=3, ipadx=0, ipady=0, padx=4, pady=4)
    b['4'].grid(row=3, column=1, ipadx=0, ipady=0, padx=4, pady=4)
    b['5'].grid(row=3, column=2, ipadx=0, ipady=0, padx=4, pady=4)
    b['6'].grid(row=3, column=3, ipadx=0, ipady=0, padx=4, pady=4)
    b['7'].grid(row=4, column=1, ipadx=0, ipady=0, padx=4, pady=4)
    b['8'].grid(row=4, column=2, ipadx=0, ipady=0, padx=4, pady=4)
